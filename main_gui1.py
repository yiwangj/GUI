...
class myWindow(QtWidgets.QMainWindow, Ui_widget):
    ...
    def read_directory(self, button_num, color):
        ...
        return sorted(array_of_img_path)

    def openImage(self, button_num, color):  
    ...
    def show_one_img(self, str_num):  
        self.color_labels[0].setText("")
        self.color_labels[1].setText("")
        self.color_labels[2].setText("")
        self.color_labels[3].setText("")
        self.color_labels[4].setText("")
        self.nocolor_labels[0].setText("")
        self.nocolor_labels[1].setText("")
        self.nocolor_labels[2].setText("")
        self.nocolor_labels[3].setText("")
        self.nocolor_labels[4].setText("")
    ...
    def open_vedio(self):
        ...
        #dir_path='/Users/wangyi/Desktop/code/video'
        for filename in os.listdir(dir_path):
            array_of_img_path.append(dir_path + "/" + filename)
